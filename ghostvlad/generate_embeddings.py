...
def main():
    ...
    SRC_PATH = r'C:\Users\user\Desktop\work\Speaker-Diarization-master\train'
    path_spk_tuples = prepare_data(SRC_PATH)
    train_sequence = []
    train_cluster_id = []

    for epoch in range(5): # Random choice utterances from whole wavfiles
    ...
    np.savez('training_data1', train_sequence=train_sequence, train_cluster_id=train_cluster_id)
