...
def main(wav_path, check, embedding_per_second=1.0, overlap_rate=0.5):
    ...
    if check != '':
        specs1, interval1 = load_data(check, embedding_per_second=1.2, overlap_rate=0.4)
...
if __name__ == '__main__':
    ...
    filepath = '/home/muthumurugan/Desktop/GoldenAudio/muthu_converted/muthu_40_mobile_boat_earphone.wav'
    # verify=int(input('Do you want to verify with another audio 0 for no 1 for yes'))
    verify = 1
    if verify:
        # check=input('Enter audio filepath to check for spekaer')
        check = '/home/muthumurugan/Desktop/GoldenAudio/muthu_converted/muthu_51sec_mobile_gionee_earphone.wav'
