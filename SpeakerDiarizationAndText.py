...
def main(file_path, check, embedding_per_second=1.0, overlap_rate=0.5):
    ...
    if not os.path.exists("/tmp/speaker/"):
    ...
    for spk, timeDicts in speakerSlice.items():
        ...
        for timeDict in timeDicts:
            ...
            e = fmtTime(e)
            print(s + ' ==> ' + e)
    print('same Speaker' if no_speakers == check_speaker else 'not the same speaker')
    print('speaker detected as ' + str(predicted_label2[-1]) if no_speakers == check_speaker else '')
